...
if [[ "$1" == "debug" ]] || [[ "$1" == "stat" ]]; then
  em++ --bind $SRC $INCLUDE_DIRS $LIBS --shell-file ui/shell.html -o "$BUILD_DIR/$NAME.html" -fexceptions -Og -flto -sASSERTIONS -sALLOW_MEMORY_GROWTH -sMAXIMUM_MEMORY=1024 || exit 1
fi
